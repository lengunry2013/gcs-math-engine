...
import com.gcs.game.engine.math.model20260825.Model20260825Bonus;
    ...
    public BaseSlotModel getSlotsModel(String mathModel) {
        ...
        switch (mathModel) {
            ...
            case "20260104":
                ...
                break;
            case "20260618":
                model = new Model20260618();
                break;
            case "20260507":
                model = new Model20260507();
                break;
            case "20260508":
            ...
            case "20260530":
                ...
                break;
            case "20260531":
                model = new Model20260531();
                break;
            case "20260625":
                model = new Model20260625();
                break;
            case "20260701":
        ...
        switch (gameModel) {
            ...
            case "20260201":
                if ("bonus1".equalsIgnoreCase(bonusAsset)) {
                    model = new Model20260201FSBonus();
            ...
            case "20260530":
                ...
                break;
            case "20260625":
                model = new Model20260625Bonus();
                break;
            case "20260825":
                model = new Model20260825Bonus();
                break;
            default:
                break;
        }
